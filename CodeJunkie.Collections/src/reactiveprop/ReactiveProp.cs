...
/// <br />
/// Reactive properties guarantee that handlers will be invoked for each distinct
...
public interface IReactiveProp<T> {
  /// <summary>
...
/// </summary>
/// <typeparam name="T">Type of the value to observe.</typeparam>
public sealed class ReactiveProp<T> : IDisposable, IReactiveProp<T> {
  /// <inheritdoc />
  ...
  /// <summary>
  /// Creates a new reactive property with the given value.
  /// </summary>
  /// <param name="value">Initial value.</param>
  public ReactiveProp(T value) {
    Value = value;
    Comparer = EqualityComparer<T>.Default;
  }

  /// <summary>
  /// Creates a new reactive property with the given value and comparer.
  /// </summary>
  /// <param name="value">Initial value.</param>
  /// <param name="comparer">Equality comparer to use.</param>
  public ReactiveProp(T value, IEqualityComparer<T> comparer) {
    Value = value;
    Comparer = comparer;
  }
